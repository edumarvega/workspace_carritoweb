...
<s:url action="jsonCaptcha_obtenerCaptcha" namespace="/" var="obtenerCaptcha" />
  <script type="text/javascript">
	...
	<s:form id="formPedido"  action="pedido_sendPedido" theme="simple"  cssClass="form-horizontal" role="form"><br>
		...
		<s:hidden id="usuarioEcommerce" name="usuario" value="%{usuario}"/>
		
		
		<div class="form-group">
    		<label for="usuario" class="col-sm-4 control-label">Usuario</label>
    		<div class="col-sm-5">
      			<input type="text" class="form-control input-sm" id="usuario" name="usuario" value="${usuario}" disabled="true">
    		</div>
  		</div>
  		...
  		<div class="form-group">
    		...
    		<div class="col-sm-5">
      			<input type="text" class="form-control input-sm" id="apellido" name="apellido" value="${apellido}" required autofocus>
    		</div>
  		</div>
  		...
  		<div class="form-group">
    		...
    		<div class="col-sm-5">
      			<input type="text" class="form-control input-sm" id="nombres" name="nombres" value="${nombres}" required>
    		</div>
  		</div>
  		<div class="form-group">
    		<label for="direccion" class="col-sm-4 control-label">Direcci&oacute;n</label>
    		<div class="col-sm-7">
      			<input type="text" class="form-control input-sm" id="direccion" name="direccion" value="${direccion}" required>
    		</div>
  		</div>
  		<div class="form-group">
    		<label for="telefono" class="col-sm-4 control-label">Tel&eacute;fono</label>
    		<div class="col-sm-5">
      			<input type="text" class="form-control input-sm" id="telefono" name="telefono" value="${telefono}" required>
    		</div>
  		</div>
  		<div class="form-group">
    		<label for="direccion" class="col-sm-4 control-label">Email</label>
    		<div class="col-sm-7">
      			<input type="text" class="form-control input-sm" id="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" value="${email}" required>
    		</div>
  		</div>
  		<div class="form-group">

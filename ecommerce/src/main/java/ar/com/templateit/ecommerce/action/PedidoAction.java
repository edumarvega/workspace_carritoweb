...
public class PedidoAction extends ActionSupport{
	...
	public String loadPedido() {
		...
		String userecommerce = (String)ActionContext.getContext().getSession().get("userecommerce");
		UsuarioEcommerce ue = this.usuarioEcommerceServiceSoap.loadUsuarioEcommerce(userecommerce, null);

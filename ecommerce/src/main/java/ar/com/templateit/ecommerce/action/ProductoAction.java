...
public class ProductoAction extends ActionSupport{
	...
	private CategoriaService categoriaServiceSoap;
	...
	public String search() {
		...
		if(!this.idCategoria.isEmpty()){
			Categoria categoria = this.categoriaServiceSoap.getCategoria(new Long(this.idCategoria));
			productosTmp = this.productoServiceSoap.findByCriteria(null, null, null, categoria);
			
		}
		else{
			if(!this.descripcion.isEmpty()){
				productosTmp = this.productoServiceSoap.findByCriteria(null, null, this.descripcion.trim(), null);
			}
			else{
				productosTmp = this.productoServiceSoap.loadAllProducto();
			}
...
//				    }
	...
	public void setProductoServiceSoap(ProductoService productoServiceSoap) {
		this.productoServiceSoap = productoServiceSoap;
	}


	public void setCategoriaServiceSoap(CategoriaService categoriaServiceSoap) {
		this.categoriaServiceSoap = categoriaServiceSoap;
	}
